...
echo "Шаг 9: Установка Python зависимостей проекта в редактируемом режиме..."
pip install -e .

echo "Шаг 10: Установка Python зависимостей..."
pip install -r requirements.txt

echo "Шаг 11: Установка JuliaCall для интеграции Julia-Python..."
...
echo "Шаг 12: Проверка установки и совместимости..."
