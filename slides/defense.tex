...
\begin{frame}
\frametitle{Постановка обратной задачи ЭЭГ}
...
\begin{enumerate}
    \item Получен метод обратной задачи уравнений в частной производной в операторной постановке.
