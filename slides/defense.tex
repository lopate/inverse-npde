...
\begin{enumerate}
    ...
    \item Доказана линейности и ограниченности оператора $T$ для уравнений Максвелла.
    \item Введен регуляризованный функционал с энергетическим членом и $\mathrm{TV}(s)$ и доказана единственность его минимума.
    \item Доказана теоремы о сходимости минимизаторов.
    \item Подтверждена вычислительным экспериментом эффективности метода на основе задачи ЭЭГ.
\end{enumerate}
